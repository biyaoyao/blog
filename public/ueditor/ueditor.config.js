...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL + "ue"            //图片上传提交地址
        ,imagePath:URL + "ue/uploadimage"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //七牛结合需要改成file
        ...
        //图片在线管理配置区
        ,imageManagerUrl:URL + "ue/uploadimage"       //图片在线管理的处理地址
        ,imageManagerPath:URL + "ue/uploadimage"                                    //图片修正地址，同imagePath
        ...
        , toolbars:[
            ['source', '|', 'undo', 'redo', '|',
             'bold', 'italic',  'fontborder',   'removeformat',  '|', 'forecolor', 'backcolor',
             '|',
